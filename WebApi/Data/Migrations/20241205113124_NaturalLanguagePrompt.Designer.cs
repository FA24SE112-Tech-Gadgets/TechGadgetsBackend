...
namespace WebApi.Data.Migrations
{
    ...
    [Migration("20241205113124_NaturalLanguagePrompt")]
    partial class NaturalLanguagePrompt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Data.Entities.Criteria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("NaturalLanguageKeywordGroupId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.CriteriaCategory", b =>
                {
                    b.Property<Guid>("CategoryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CategoryId", "CriteriaId");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.NaturalLanguageKeyword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.NaturalLanguagePrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("NaturalLanguagePrompts");
                });
            ...
            modelBuilder.Entity("WebApi.Data.Entities.WalletTracking", b =>
                {
                    ...
                    b.Property<long?>("BalanceBeforeChange")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.Criteria", b =>
                {
                    b.HasOne("WebApi.Data.Entities.NaturalLanguageKeywordGroup", "NaturalLanguageKeywordGroup")
                        .WithMany("Criteria")
                        .HasForeignKey("NaturalLanguageKeywordGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("NaturalLanguageKeywordGroup");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.CriteriaCategory", b =>
                {
                    b.HasOne("WebApi.Data.Entities.Category", "Category")
                        .WithMany("CriteriaCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApi.Data.Entities.Criteria", "Criteria")
                        .WithMany("CriteriaCategories")
            ...
            modelBuilder.Entity("WebApi.Data.Entities.NaturalLanguageKeyword", b =>
                {
                    b.HasOne("WebApi.Data.Entities.NaturalLanguageKeywordGroup", "NaturalLanguageKeywordGroup")
                        .WithMany("NaturalLanguageKeywords")
                        .HasForeignKey("NaturalLanguageKeywordGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApi.Data.Entities.Category", b =>
                {
                    ...
                    b.Navigation("CriteriaCategories");
            ...
            modelBuilder.Entity("WebApi.Data.Entities.NaturalLanguageKeywordGroup", b =>
                {
                    ...
                    b.Navigation("NaturalLanguageKeywords");
                });
